...
router.post('/hangoutcenter/getHangoutCenterByEmail', async (req, res, next) => { center.getOneCenterByMail(req, res, next) });
router.post('/hangoutcenter/getAllHangoutCenter', async(req, res, next)=>{center.getAllHangoutCenters(req, res, next)})
