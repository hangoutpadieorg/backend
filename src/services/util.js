...
class Utilities {
  ...
  getFilePath(req) {
    let files = req.files;
    const myFirstFile1 = files[0].path;
    const myFirstFile2 = files[1]?.path;
    const myFirstFile3 = files[2]?.path;
    return {
      file1: myFirstFile1,
      file2: myFirstFile2,
      file3: myFirstFile3,
...
const multipleUpload = upload.fields([
  ...
  // { name: 'file4', maxCount: 1 }, { name: 'file5', maxCount: 1 }
]);
module.exports = { Utilities, upload, multipleUpload };
